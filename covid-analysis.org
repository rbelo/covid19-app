...
dt.confirmed <- prep.timeseries.data("~/project/covid19-app/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Confirmed.csv")
dt.deaths    <- prep.timeseries.data("~/project/covid19-app/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Deaths.csv")
dt.recovered <- prep.timeseries.data("~/project/covid19-app/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Recovered.csv")
...
dt.covid <- rbind(dt.confirmed[, list(country, date, event_type = "confirmed", cases)],
                  ...
                  dt.recovered[, list(country, date, event_type = "recovered", cases)])
